...
let MOCK_TEMPLATES: MessageTemplate[] = [
  {
    ...
    title: 'تقسيط برو 📋',
    body: 'السلام عليكم {اسم_العميل}، نذكركم بأن قسطكم البالغ {مبلغ_القسط} ر.س مستحق في {تاريخ_القسط}. يرجى السداد في الموعد المحدد. شكراً لتعاملكم معنا.',
  },
  {
    id: '2', name: 'تنبيه تأخر الدفع (يوم التأخر)', isActive: true,
    trigger: 'تُرسل يوم استحقاق القسط إذا لم يُسدَّد',
    title: 'تقسيط برو ⚠️',
    body: 'السلام عليكم {اسم_العميل}، قسطكم البالغ {مبلغ_القسط} ر.س استحق اليوم ولم يتم السداد. يرجى التواصل معنا أو السداد فوراً لتجنب الرسوم الإضافية.',
  },
  {
    id: '3', name: 'إيصال استلام الدفعة', isActive: true,
    trigger: 'تُرسل فور تسجيل الدفعة',
    title: 'تقسيط برو ✅',
    body: 'شكراً {اسم_العميل}! تم استلام دفعتكم {مبلغ_المدفوع} ر.س بتاريخ {تاريخ_الدفع}. المتبقي على عقدكم: {الباقي} ر.س. نقدر ثقتكم بنا.',
  },
];
...
const MOCK_LOG: MessageLogEntry[] = [
  ...
  { id: '3', customerName: 'فيصل الدوسري',   type: 'إيصال دفعة 600 ر.س', time: '10:30 ص', status: 'sent'   },
