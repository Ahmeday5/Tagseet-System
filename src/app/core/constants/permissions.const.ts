...
export const PERMISSIONS = {
  ...
  productsFullAccess:    'Products.FullAccess',
  warehousesView:        'Warehouses.View',
  warehousesFullAccess:  'Warehouses.FullAccess',
  treasuryView:          'Treasury.View',
  treasuryFullAccess:    'Treasury.FullAccess',
  vouchersFullAccess:    'Vouchers.FullAccess',
...
> = Object.freeze({
  Admin: [
    ...
    PERMISSIONS.productsFullAccess,
    PERMISSIONS.warehousesView,
    PERMISSIONS.warehousesFullAccess,
    PERMISSIONS.treasuryView,
    PERMISSIONS.treasuryFullAccess,
    PERMISSIONS.vouchersFullAccess,
