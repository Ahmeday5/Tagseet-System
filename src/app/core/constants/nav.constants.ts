    ...
    items: [
      {
        ...
        route: '/warehouse',
        icon: 'warehouse',
        requiredAnyPermission: [PERMISSIONS.warehousesView],
        // Safety net until every backend deployment issues Warehouses.View —
        // some sessions still carry neither the old nor the new key.
        requiredAnyRole: ['Representative'],
      },
      {
        id: 'products',
        ...
        route: '/products',
        icon: 'products',
        requiredAnyPermission: [PERMISSIONS.productsView],
        requiredAnyRole: ['Representative'],
      },
      {
        id: 'categories',
